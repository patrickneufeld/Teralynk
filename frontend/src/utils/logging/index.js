...
if (import.meta.env.VITE_ENABLE_MCP === 'true') {
  console.log('[MCP] Enabled with protocol:', import.meta.env.VITE_MCP_DEFAULT_PROTOCOL);
}

// ==========================================
// ✅ Base Structured Log Methods
// ==========================================
...
// ==========================================
// ✅ createLogger Utility (Fix for tokenManager)
// ==========================================
