...
import { processAIQuery } from "./aiIntegration.mjs";
import { sqsClient, redisClient } from "../config/rabbitmq.mjs";
...
export const processSQSQueries = async () => {
  ...
  logAuditEntry({ action: 'AI operation', result: accessResponse, file: 'aiQueryDispatcher.mjs' });
